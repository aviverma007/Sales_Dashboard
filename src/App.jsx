          ...
          <div style={{ minWidth: '280px', flex: '0 0 auto' }}>
            <GlassCard title="Collection Progress" icon={<IndianRupee size={15}/>} color="var(--blue)" delay={0.5} style={{ height: '100%' }}>
              <div style={{ position:'relative', height:'200px', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                <div style={{ fontFamily:"'Space Mono',monospace", fontSize:32, fontWeight:700, color:'var(--blue)' }}>{collection}%</div>
                <div style={{ fontSize:11, color:'var(--text3)', fontWeight:600, textTransform:'uppercase', letterSpacing:1, marginTop:8 }}>Collected</div>
                <div style={{ fontSize:12, color:'var(--text2)', marginTop:12, textAlign:'center' }}>
                  ₹ {fmt(kpi.received)}
                </div>
              </div>
            </GlassCard>
